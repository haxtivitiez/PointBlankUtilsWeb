...

{
    ...
    if($result){
        ...
        $ISp_Res = $connec->prepare("UPDATE accounts SET name_color = ".$color_num." WHERE token = '".$token."'");
        $ISp_Res->execute();
         echo "<script>alert('NAME COLOR CHANGED.');window.location.href='index.php';</script>";
       /* $_SESSION['toastr'] = array(
    'type'      => 'error', // or 'success' or 'info' or 'warning'
